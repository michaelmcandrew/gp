...
class CRM_Member_Page_Tab extends CRM_Core_Page {
   ...
   /**
    ...
    function edit( ) 
    {
		...
		// if you are not adding a new membership, get associated contributions (if you area adding a new membership, there won't be any
   ...
   /**
    ...
    function associatedContribution( $contactId = null, $membershipId = null )
    {
		...
		//Only try and retrieive membership contributions if the membership_id is set
