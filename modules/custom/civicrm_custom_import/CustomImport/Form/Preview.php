...
class CustomImport_Form_Preview extends CRM_Core_Form {
    ...
    public function preProcess()
    {
		...
		require_once('CustomImport/Parser/Mandate.php');
//		print_r($this->get('importTableName'));
		$preview= new CustomImport_Parser_Mandate();
		$preview->db_table=$this->get('importTableName');
		$preview->test();
