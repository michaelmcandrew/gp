 ...
 * statistics
 */
class CustomImport_DDPaymentPaper_Form_Preview extends CRM_Core_Form {

    public function preProcess()
    {
        //get the data from the session
        if($this->get( 'import_done')!=TRUE) {             
			require_once('CustomImport/Parser/DDPaymentPaper.php');
			$ImportJob = new CustomImport_Parser_DDPaymentPaper();
