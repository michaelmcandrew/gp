 ...
 * statistics
 */
class CustomImport_SOPayment_Form_Preview extends CRM_Core_Form {

    public function preProcess()
    {
        //get the data from the session
        if($this->get( 'import_done')!=TRUE) {             
			require_once('CustomImport/Parser/SOPayment.php');
			$ImportJob = new CustomImport_Parser_SOPayment();
    ...
    public function buildQuickForm( ) {
        ...
        $previousURL = CRM_Utils_System::url('civicrm/import/sopayment', $path, false, null, false);
        $cancelURL   = CRM_Utils_System::url('civicrm/import/sopayment', 'reset=1');
