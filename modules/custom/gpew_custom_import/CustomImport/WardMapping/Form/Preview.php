 ...
 * statistics
 */
class CustomImport_WardMapping_Form_Preview extends CRM_Core_Form {

    public function preProcess()
    {
        //get the data from the session
        if($this->get( 'import_done')!=TRUE) {             
			require_once('CustomImport/Parser/WardMapping.php');
			$ImportJob = new CustomImport_Parser_WardMapping();
    ...
    public function buildQuickForm( ) {
        ...
        $previousURL = CRM_Utils_System::url('civicrm/import/wardmapping', $path, false, null, false);
        $cancelURL   = CRM_Utils_System::url('civicrm/import/wardmapping', 'reset=1');
...
//		$importJob->setFormVariables( $this );
		...
		$errorFilename = "ddpayment." . $this->get('importTableName') . ".custom.report.csv"; 
