 ...
 *  imported.
 */
class CustomImport_WardMapping_Form_DataSource extends CRM_Core_Form {
    ...
    public function preProcess( ) {
        ...
        $this->assign('downloadWardMapping',  $this->get('civicrm/export/wardmapping')); 
		...
		//MM: not sure what this does but would like to know :) - it looks like it is looking in the post to see if there is a data source, hmmm... (all may explained below in the buildQuickForm)
    ...
    public function buildQuickForm( ) {
		...
		unset($dataSources['CRM_Import_DataSource_SQL']);
