 ...
 * statistics
 */
class CustomImport_DDPayment_Form_Preview extends CRM_Core_Form {

    public function preProcess()
    {
        //get the data from the session
        if($this->get( 'import_done')!=TRUE) {             
			require_once('CustomImport/Parser/DDPayment.php');
			$ImportJob = new CustomImport_Parser_DDPayment();
