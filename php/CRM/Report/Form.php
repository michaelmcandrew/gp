...
class CRM_Report_Form extends CRM_Core_Form {
    ...
    function whereClause( &$field, $op,
        ...
        // BEGIN HACK
        // For some reason autocomplete fields don't supply a type.
        // We made this change so that the local party which is an autocomplete
        // field will display on the report criteria, Party information
        // civicrm/report/instance/15?reset=1
        if (empty($type)) {
          $type = 'Integer';
        }
        // END HACK
